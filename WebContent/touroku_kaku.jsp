...
if(tel.length()>20)
 ...
 //エラーがあったらエラーを返して戻る
if(e!="")
	tableHTML += "<META http-equiv='Refresh' content='0;URL=http://localhost:8080/juushoroku/touroku.jsp?e="+ e +"'>";
else  tableHTML ="";
%>
...
<body>
<tr><big><b>住所録管理システム：住所録登録確認</b></big></tr>
<body>
...
<%--DB接続 --%>
<form method="post" action="http://localhost:8080/juushoroku/touroku">
